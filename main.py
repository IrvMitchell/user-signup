...
# CREATE A ROUTE TO PROCESS AND VALIDATE THE FORM

@app.route("/signup", methods=['POST'])
def user_signup_complete():

    # CREATE VARIABLES FROM THE FORM INPUTS
    ...
    # CREATE THE ERROR MESSAGES FOR EVENTS THAT OCCUR MORE THAN ONCE
    ...
    # AND SECOND PASSWORD VALIDATION TOO
    ...
    # CREATE THE USERNAME VALIDATION
    ...
    # IF THERE ARE ERRORS, THIS WILL STAY ON THE MAIN.HTML (FORM) AND DISPLAY
    # THE ERROR MSGS
